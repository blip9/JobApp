...
<%@ page import="com.taurus.jobapp.model.Jobpost" %>
<%@ page import="com.taurus.jobapp.repo.Jobrepo" %>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNav">
            <ul class="navbar-nav ms-auto">
                ...
                <li class="nav-item"><a class="nav-link" href="https://www.linkedin.com/in/tushar-adhikari-b5281026b/">Contact</a></li>
            </ul>
        </div>
    </div>
</nav>
